...
export function accountsByStage(data) {
  return data.accounts.reduce((acc, acct) => {
...
export function filterAccounts(data, filters) {
...
export function suggestNextPlay(accountId, data) {
