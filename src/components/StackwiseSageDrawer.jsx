...
import { Input } from './ui-replit/input'
import { PushToEvalButton } from './PushToEvalButton'
export function StackwiseSageDrawer({ module = 'BrandCraft' }) {
  ...
  return (
    <>
      ...
      {!open && (
        ...
        >
          <img src="/white-logo-half.png" alt="" className="w-4 h-4 mr-1.5" /> Stackwise Sage
        </Button>
      )}
          ...
          >
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-base font-bold flex items-center" style={{ color: style.textColor }}>
                <img src="/white-logo-half.png" alt="" className="w-5 h-5 mr-2 p-0.5 rounded" style={{ backgroundColor: style.bgSelectedColor }} /> Stackwise Sage
              </h2>
