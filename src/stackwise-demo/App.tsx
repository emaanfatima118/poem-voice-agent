...
import DocumentationTemplate from '@/stackwise-demo/pages/resources/DocumentationTemplate'
import Glossary from '@/stackwise-demo/pages/resources/Glossary'
import RecycleBin from '@/stackwise-demo/pages/RecycleBin'

// Legacy
import Dashboard from '@/stackwise-demo/pages/Dashboard'
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/resources/documentation" component={DocumentationTemplate} />
