...
export default function ContentAudit() {
  ...
  const mainContent = (
    <div className="space-y-6 p-8 brandcraft-buttons">
      <style>{`
      ...
      <AnimatePresence mode="wait">
        ...
        {currentStep === 'action-plan' && (
          ...
          >
            ...
            <Card className="border-l-4 mt-6" style={{ borderLeftColor: moduleColor }}>
              <CardContent className="p-4">
                <div className="flex gap-3">
                  <Lightbulb className="w-[18px] h-[18px] flex-shrink-0 mt-0.5" style={{ color: moduleColor }} />
                  <p className="text-sm">
                    <strong>Coaching Prompt:</strong> Re-run this audit every 60-90 days to measure improvement and identify new opportunities. Great content strategies are iterative.
                  </p>
                </div>
              </CardContent>
            </Card>
