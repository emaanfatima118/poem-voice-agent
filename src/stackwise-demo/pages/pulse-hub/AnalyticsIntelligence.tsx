      ...
      return (
        <div className="h-full overflow-y-auto overflow-x-hidden bg-white">
          <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8 lg:space-y-12">
              {/* Business Goals */}
              <div>
                <h2 className="text-xl sm:text-2xl font-bold mb-4" style={{ color: moduleColor }}>Business Goals</h2>
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold mb-4" style={{ color: moduleColor }}>Visibility + Performance</h3>
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold mb-4" style={{ color: moduleColor }}>Engagement Indicators</h3>
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
                  {[
          ...
          <div className="max-w-7xl mx-auto p-8 space-y-6">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-2xl font-bold" style={{ color: moduleColor }}>AI Findings, Insights & Recommendations</h2>
                  <Button
                    onClick={() => setShowBudgetRequestDialog(true)}
                    variant="outline"
                    style={{ borderColor: moduleColor }}
                    data-testid="button-request-budget-change-intelligence"
                  >
  ...
  return (
    <>
      ...
      <RequestBudgetChangeDialog
        ...
        availableChannels={['Google Ads', 'LinkedIn Ads', 'Facebook Ads', 'Instagram Ads', 'Email Marketing', 'Content Marketing', 'SEO/SEM']}
        channelBudgets={{
          'Google Ads': 15000,
          'LinkedIn Ads': 12000,
          'Facebook Ads': 8000,
        ...
        recommendationContext="Budget adjustment based on AI-powered performance insights and recommendations"
        sourceFeature="pulse-hub-analytics-intelligence"
      />
    </>
  );
}
