...
import { Search, Plus, Minus, TrendingUp, ArrowUpRight, ArrowDownRight, ArrowRight, Calendar, Lightbulb, Rocket } from 'lucide-react'
...
export default function FlightDeck() {
  ...
  const mockCampaigns = [
    ...
    { id: 3, name: 'EXPO World - Follow Up', activity: 'Now Boarding', status: 'boarding', ctr: '-', leads: '-' },
  ]
