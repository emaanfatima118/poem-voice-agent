        ...
        {steps.map((step) => {
          ...
          return (
            <button
              ...
              style={isActive ? { backgroundColor: '#1e40f2' } : {}}
  ...
  return (
    <>
      ...
      <div className="flex h-screen overflow-hidden overflow-x-hidden bg-background">
        {/* LEFT COLUMN: Progress Steps - Hidden on mobile */}
        <div className="hidden md:flex w-72 border-r flex-col overflow-hidden overflow-x-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-4">
            {selectedAudience && (
              <>
                <Card className="p-4">
                  <div className="text-sm text-muted-foreground mb-1">Selected Audience</div>
                  <div className="font-semibold">{selectedAudience.name}</div>
                  <div className="flex items-center gap-2 mt-2 text-sm text-muted-foreground">
                    <Users className="w-4 h-4" />
                    <span>{selectedAudience.audienceSize.toLocaleString()} contacts</span>
                  </div>
                </Card>

                {selectedPairings.length > 0 && (
                  <Card className="p-4 bg-purple-50 dark:bg-purple-950/30 border-purple-200 dark:border-purple-800">
                    <div className="text-sm text-purple-600 dark:text-purple-400 mb-1">Content Selected</div>
            ...
            <Card className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 border-purple-200 dark:border-purple-800">
              ...
              <p className="text-xs text-purple-800 dark:text-purple-200">
                Recommendations update daily based on audience behavior and content performance
              </p>
            </Card>
          </div>
        </div>
