...
export default function CampaignInsights() {
  ...
  return (
    <div className="h-full flex bg-background overflow-x-hidden min-w-0">
      {/* Left Navigation - Column 1 - Hidden on mobile */}
      <div className="hidden md:block w-64 border-r p-6 space-y-6 overflow-y-auto overflow-x-hidden">
        <div>
      ...
      <main ref={mainContentRef} className="flex-1 overflow-y-auto overflow-x-hidden min-w-0 p-4 md:p-8 space-y-8">
      ...
      {/* Right Sidebar - Column 3 (Future use for insights/tips) */}
      <div className="hidden lg:block w-80 border-l p-6 space-y-6 overflow-y-auto overflow-x-hidden">
        <div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      LinkedIn campaigns averaged 156% ROI this period
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      16% of campaigns delayed due to creative bottlenecks
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-semibold">Goal Achievement</p>
                    <p className="text-xs text-muted-foreground mt-1">
                      89% alignment score with business objectives
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <div>
          ...
          <div className="space-y-2 text-sm">
            <div className="p-2 rounded hover-elevate">
              <p className="font-medium">Q3 2024 Report</p>
              <p className="text-xs text-muted-foreground">Saved Oct 15, 2024</p>
            </div>
            <div className="p-2 rounded hover-elevate">
              <p className="font-medium">Q2 2024 Report</p>
              <p className="text-xs text-muted-foreground">Saved Jul 20, 2024</p>
            </div>
            <div className="p-2 rounded hover-elevate">
              <p className="font-medium">Q1 2024 Report</p>
              <p className="text-xs text-muted-foreground">Saved Apr 18, 2024</p>
            </div>
          </div>
        </div>
      </div>
